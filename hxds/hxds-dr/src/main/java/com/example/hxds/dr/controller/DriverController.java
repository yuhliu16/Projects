...
import com.example.hxds.dr.controller.form.UpdateDriverForm;
...
public class DriverController {
    ...
    public R updateDriverAuth(@RequestBody @Valid UpdateDriverForm form) {
        Map param = BeanUtil.beanToMap(form);
    ...
    public R searchDriverBaseInfo(@RequestBody @Valid SearchDriverBaseInfoForm form) {
        return R.ok().put("result", driverService.searchDriverBaseInfo(form.getDriverId()));
    }
